...
public class AppDataContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Tarefa>().HasData(
            ...
            new Tarefa { TarefaId = 4, Titulo = "Consertar o computador", Descricao = "Substituir processador por um novo", CriadoEm = DateTime.Now.AddDays(10), CategoriaId = 1 },
            new Tarefa { TarefaId = 5, Titulo = "Continuar pesquisa", Descricao = "Prosseguir com a pesquisa sobre ML", CriadoEm = DateTime.Now.AddDays(14), CategoriaId = 2 }
        );
    }
}
